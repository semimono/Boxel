...
/**
 * Boxel editor actions
 */
class FBoxelEditorCommands : public TCommands<FBoxelEditorCommands>
{

public:
	FBoxelEditorCommands() : TCommands<FBoxelEditorCommands>
	(
		"BoxelEditor", // Context name for fast lookup
		NSLOCTEXT("Contexts", "BoxelEditor", "Boxel Editor"), // Localized context name for displaying
